  ...
  return (
    ...
    >
      <div className="relative w-full max-w-7xl max-h-full">
        {/* Modal content */}
        <div className="relative md:static bg-neutral-primary-soft border border-default rounded-base shadow-sm p-4 md:p-6">
          {/* Modal header */}
          <div className="relative flex items-center flex-col md:flex-row justify-between gap-5 md:gap-10 border-b border-default pb-4 md:pb-5">
            ...
            <button
              type="button"
              className="absolute top-0 right-0 md:static text-body bg-transparent hover:bg-neutral-tertiary hover:text-heading rounded-base text-sm w-9 h-9 ms-auto inline-flex justify-center items-center"
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16 mb-12">
                ...
                <div className="mt-6 sm:mt-8 lg:mt-0">
                  ...
                  <div className="mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8">
                    ...
                    <div className="mt-4 sm:mt-0 flex items-center justify-start sm:justify-between gap-2">
